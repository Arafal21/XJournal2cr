...
export const metadata = {  
    ...
    description: "As a director, easily manage and update student, teacher, and staff records. XJournal offers a streamlined process for maintaining accurate user information.",  
};  
